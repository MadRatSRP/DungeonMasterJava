...
class HeroData extends JLabel {
    ...
    public void equipEffect(Item it) {
        ...
        for (int i = it.effect.length; i > 0; i--) {
            ...
            if (whataffected.equals("mana")) maxmana += e;
            else if (whataffected.equals("health")) maxhealth += e;
            else if (whataffected.equals("stamina")) maxstamina += e;
            else if (whataffected.equals("strength")) strength += e;
            else if (whataffected.equals("vitality")) vitality += e;
            else if (whataffected.equals("dexterity")) dexterity += e;
            else if (whataffected.equals("intelligence")) intelligence += e;
            else if (whataffected.equals("wisdom")) wisdom += e;
                //else if (whataffected.equals("load")) maxload+=e;
        ...
        setMaxLoad();
                /*
                maxload = strength*4/5;
                if (stamina<maxstamina/5) maxload=maxload*1/2;
                else if (stamina<maxstamina/4) maxload=maxload*2/3;
                else if (stamina<maxstamina/3) maxload=maxload*3/4;
                */
    }
    ...
    public void unEquipEffect(Item it) {
        ...
        setMaxLoad();
                /*
                maxload = strength*4/5;
                //if (stamina<maxstamina/5) maxload*=3/4;
                if (stamina<maxstamina/5) maxload=maxload*1/2;
                else if (stamina<maxstamina/4) maxload=maxload*2/3;
                else if (stamina<maxstamina/3) maxload=maxload*3/4;
                */
    ...
    public void save(ObjectOutputStream so) throws IOException {
        ...
        if (weapon.name.equals("Fist/Foot")) so.writeBoolean(false);
        else {
    ...
    public void load(ObjectInputStream si) throws IOException, ClassNotFoundException {
        ...
        if (si.readBoolean()) {
            ...
            if (weapon.number == 6) weapon = Item.fistfoot;//fix for earlier typo
        } else weapon = Item.fistfoot;
        if (si.readBoolean()) {
